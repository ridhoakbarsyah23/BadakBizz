...
export default function LoginPage() {
  ...
  return (
    <main className="relative flex min-h-dvh w-full flex-col overflow-hidden bg-slate-50 px-4 sm:px-6">
        ...
        >
          <div className="px-5 py-5 sm:px-8 sm:py-6 lg:px-10 lg:py-7 max-[700px]:py-4">
            ...
            <div className="mt-5 border-t border-slate-100 pt-4 sm:mt-6 sm:pt-5 max-[700px]:mt-4 max-[700px]:pt-3">
              <p className="mb-4 text-center text-sm font-semibold text-slate-500 max-[700px]:mb-3 max-[700px]:text-xs">
                Belum punya akun?{" "}
                <Link href="/register" className="font-black text-primary hover:text-primary/80">
                  Daftar sekarang
                </Link>
              </p>
      ...
      <div className="z-10 w-full max-w-md self-center pb-3">
        <AppFooter />
      </div>
    </main>
  )
